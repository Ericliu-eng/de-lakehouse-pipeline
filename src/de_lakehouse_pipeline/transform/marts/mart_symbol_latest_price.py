...
def run_latest_price(conn=None):
    root = Path(__file__).resolve().parents[4]
    sql_file_path = root / "sql/marts/mart_symbol_latest_price.sql"
    ...
    logger.info("Mart 2: Successfully updated latest snapshots for all symbols.")
